...
// export const encryptWithRSA = async (publicKey, text) => {
...
//   const savedPrivateKey = await importRSAKeyFromPEM(savedPrivateKeyPEM, false);
...
// ): Promise<string | undefined> => {
//   // convert token string to cryptokey type
//   const convertedPrivateKey = await importRSAKeyFromPEM(privateKey, true);
